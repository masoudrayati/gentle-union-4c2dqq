...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/gentle-union-4c2dqq#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-union-4c2dqq
```

A live public deployment of this template is available at [https://gentle-union-4c2dqq.templates.workers.dev](https://gentle-union-4c2dqq.templates.workers.dev)
